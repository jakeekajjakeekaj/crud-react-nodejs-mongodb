...
//         if (err) reject(err);
//         resolve(token);
//         // POdemos enviarlo así, el problema de enviarlo así para ser trabajo en el front, es que luego desde el front se tendrá que estar leyendo el body y varias cosas que se deberían hacer, es por esto que mejor se optará por manejar cookies como en auth.controller
//         // else res.json({ token });
